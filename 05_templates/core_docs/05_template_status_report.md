---
title: Programa de Transformação DEI - Relatório de Status de Novembro de 2025
uuid: report-dei-202511
...
tags:
  ...
  - cliente-exemplo
  - relatorio-mensal
created: 2025-05-22T04:13
updated: 2025-11-05T09:21
---
...
```mermaid
pie title Status de Conclusão das Fases do Projeto
    "Diagnóstico" : 25
    "Letramento e Planejamento" : 50
    "Implementação de Políticas" : 25
```
...
```mermaid
gantt
    title Cronograma do Projeto de Transformação DEI
    dateFormat  YYYY-MM-DD
    section Fase 1: Diagnóstico
    Início do Projeto     :done, 2025-09-15, 2d
    Censo de Diversidade  :done, 2025-09-17, 30d
    Análise e Relatório   :done, 2025-10-17, 14d
    section Fase 2: Letramento e Planejamento
    Workshops Liderança   :active, 2025-11-01, 28d
    Desenvolvimento Políticas :2025-11-29, 45d
    section Fase 3: Implementação
    Auditoria Salarial    :2026-01-16, 30d
    Grupos de Afinidade   :2026-02-16, 15d
```
...
```mermaid
graph TD
    A[Orçamento Total] --> B[Gasto: 45,3%]
    B --> C[Restante: 54,7%]
    B --> D[Em Andamento]
```
